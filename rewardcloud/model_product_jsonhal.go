...
// checks if the ProductJsonhal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductJsonhal{}
...
func (o ProductJsonhal) ToMap() (map[string]interface{}, error) {
