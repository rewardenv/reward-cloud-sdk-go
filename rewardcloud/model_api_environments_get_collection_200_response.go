...
// checks if the ApiEnvironmentsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiEnvironmentsGetCollection200Response{}
...
func (o ApiEnvironmentsGetCollection200Response) ToMap() (map[string]interface{}, error) {
