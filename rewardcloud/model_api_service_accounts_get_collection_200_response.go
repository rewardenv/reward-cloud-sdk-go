...
// checks if the ApiServiceAccountsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiServiceAccountsGetCollection200Response{}

// ApiServiceAccountsGetCollection200Response struct for ApiServiceAccountsGetCollection200Response
type ApiServiceAccountsGetCollection200Response struct {
	Embedded []ServiceAccountJsonhal `json:"_embedded"`
...
func NewApiServiceAccountsGetCollection200Response(embedded []ServiceAccountJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiServiceAccountsGetCollection200Response {
	this := ApiServiceAccountsGetCollection200Response{}
...
func (o ApiServiceAccountsGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiServiceAccountsGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiServiceAccountsGetCollection200Response struct {
	value *ApiServiceAccountsGetCollection200Response
	isSet bool
}

func (v NullableApiServiceAccountsGetCollection200Response) Get() *ApiServiceAccountsGetCollection200Response {
	return v.value
}

func (v *NullableApiServiceAccountsGetCollection200Response) Set(val *ApiServiceAccountsGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiServiceAccountsGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiServiceAccountsGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiServiceAccountsGetCollection200Response(val *ApiServiceAccountsGetCollection200Response) *NullableApiServiceAccountsGetCollection200Response {
	return &NullableApiServiceAccountsGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiServiceAccountsGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiServiceAccountsGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
