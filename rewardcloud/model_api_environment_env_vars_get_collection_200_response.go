...
// checks if the ApiEnvironmentEnvVarsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiEnvironmentEnvVarsGetCollection200Response{}

// ApiEnvironmentEnvVarsGetCollection200Response struct for ApiEnvironmentEnvVarsGetCollection200Response
type ApiEnvironmentEnvVarsGetCollection200Response struct {
	Embedded []EnvironmentEnvVarJsonhal `json:"_embedded"`
...
func NewApiEnvironmentEnvVarsGetCollection200Response(embedded []EnvironmentEnvVarJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiEnvironmentEnvVarsGetCollection200Response {
	this := ApiEnvironmentEnvVarsGetCollection200Response{}
...
func (o ApiEnvironmentEnvVarsGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiEnvironmentEnvVarsGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiEnvironmentEnvVarsGetCollection200Response struct {
	value *ApiEnvironmentEnvVarsGetCollection200Response
	isSet bool
}

func (v NullableApiEnvironmentEnvVarsGetCollection200Response) Get() *ApiEnvironmentEnvVarsGetCollection200Response {
	return v.value
}

func (v *NullableApiEnvironmentEnvVarsGetCollection200Response) Set(val *ApiEnvironmentEnvVarsGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiEnvironmentEnvVarsGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiEnvironmentEnvVarsGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiEnvironmentEnvVarsGetCollection200Response(val *ApiEnvironmentEnvVarsGetCollection200Response) *NullableApiEnvironmentEnvVarsGetCollection200Response {
	return &NullableApiEnvironmentEnvVarsGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiEnvironmentEnvVarsGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiEnvironmentEnvVarsGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
