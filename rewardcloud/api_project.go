...
func (r ProjectApiApiProjectsGetCollectionRequest) Execute() ([]ProjectProjectOutput, *http.Response, error) {
...
//
//	@return []ProjectProjectOutput
func (a *ProjectApiService) ApiProjectsGetCollectionExecute(r ProjectApiApiProjectsGetCollectionRequest) ([]ProjectProjectOutput, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue []ProjectProjectOutput
	)
...
func (r ProjectApiApiProjectsIdGetRequest) Execute() (*ProjectProjectOutput, *http.Response, error) {
...
//
//	@return ProjectProjectOutput
func (a *ProjectApiService) ApiProjectsIdGetExecute(r ProjectApiApiProjectsIdGetRequest) (*ProjectProjectOutput, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ProjectApiApiProjectsIdPatchRequest struct {
	ctx                 context.Context
	ApiService          *ProjectApiService
	projectProjectInput *ProjectProjectInput
	id                  string
}

// The updated Project resource
func (r ProjectApiApiProjectsIdPatchRequest) ProjectProjectInput(projectProjectInput ProjectProjectInput) ProjectApiApiProjectsIdPatchRequest {
	r.projectProjectInput = &projectProjectInput
	return r
}

func (r ProjectApiApiProjectsIdPatchRequest) Execute() (*ProjectProjectOutput, *http.Response, error) {
...
//
//	@return ProjectProjectOutput
func (a *ProjectApiService) ApiProjectsIdPatchExecute(r ProjectApiApiProjectsIdPatchRequest) (*ProjectProjectOutput, *http.Response, error) {
	var (
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.projectProjectInput == nil {
		return localVarReturnValue, nil, reportError("projectProjectInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.projectProjectInput
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
// The updated Project resource
func (r ProjectApiApiProjectsIdPutRequest) ProjectProjectInput(projectProjectInput ProjectProjectInput) ProjectApiApiProjectsIdPutRequest {
	r.projectProjectInput = &projectProjectInput
	return r
}

func (r ProjectApiApiProjectsIdPutRequest) Execute() (*ProjectProjectOutput, *http.Response, error) {
...
//
//	@return ProjectProjectOutput
func (a *ProjectApiService) ApiProjectsIdPutExecute(r ProjectApiApiProjectsIdPutRequest) (*ProjectProjectOutput, *http.Response, error) {
	var (
...
func (r ProjectApiApiProjectsIdcostsGetRequest) Execute() (*ProjectProjectOutput, *http.Response, error) {
...
//
//	@return ProjectProjectOutput
func (a *ProjectApiService) ApiProjectsIdcostsGetExecute(r ProjectApiApiProjectsIdcostsGetRequest) (*ProjectProjectOutput, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
func (r ProjectApiApiProjectsPostRequest) ProjectProjectInput(projectProjectInput ProjectProjectInput) ProjectApiApiProjectsPostRequest {
	r.projectProjectInput = &projectProjectInput
	return r
}

func (r ProjectApiApiProjectsPostRequest) Execute() (*ProjectProjectOutput, *http.Response, error) {
...
//
//	@return ProjectProjectOutput
func (a *ProjectApiService) ApiProjectsPostExecute(r ProjectApiApiProjectsPostRequest) (*ProjectProjectOutput, *http.Response, error) {
	var (
