...
// checks if the ApiGitsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiGitsGetCollection200Response{}

// ApiGitsGetCollection200Response struct for ApiGitsGetCollection200Response
type ApiGitsGetCollection200Response struct {
	Embedded []GitJsonhal `json:"_embedded"`
...
func NewApiGitsGetCollection200Response(embedded []GitJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiGitsGetCollection200Response {
	this := ApiGitsGetCollection200Response{}
...
func (o ApiGitsGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiGitsGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiGitsGetCollection200Response struct {
	value *ApiGitsGetCollection200Response
	isSet bool
}

func (v NullableApiGitsGetCollection200Response) Get() *ApiGitsGetCollection200Response {
	return v.value
}

func (v *NullableApiGitsGetCollection200Response) Set(val *ApiGitsGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiGitsGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiGitsGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiGitsGetCollection200Response(val *ApiGitsGetCollection200Response) *NullableApiGitsGetCollection200Response {
	return &NullableApiGitsGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiGitsGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiGitsGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
