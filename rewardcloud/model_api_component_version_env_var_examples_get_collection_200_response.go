...
// checks if the ApiComponentVersionEnvVarExamplesGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiComponentVersionEnvVarExamplesGetCollection200Response{}
...
func (o ApiComponentVersionEnvVarExamplesGetCollection200Response) ToMap() (map[string]interface{}, error) {
