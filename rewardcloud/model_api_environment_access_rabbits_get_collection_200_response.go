...
// checks if the ApiEnvironmentAccessRabbitsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiEnvironmentAccessRabbitsGetCollection200Response{}

// ApiEnvironmentAccessRabbitsGetCollection200Response struct for ApiEnvironmentAccessRabbitsGetCollection200Response
type ApiEnvironmentAccessRabbitsGetCollection200Response struct {
	Embedded []EnvironmentAccessRabbitJsonhal `json:"_embedded"`
...
func NewApiEnvironmentAccessRabbitsGetCollection200Response(embedded []EnvironmentAccessRabbitJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiEnvironmentAccessRabbitsGetCollection200Response {
	this := ApiEnvironmentAccessRabbitsGetCollection200Response{}
...
func (o *ApiEnvironmentAccessRabbitsGetCollection200Response) GetEmbedded() []EnvironmentAccessRabbitJsonhal {
	if o == nil {
		var ret []EnvironmentAccessRabbitJsonhal
		return ret
	}
...
func (o ApiEnvironmentAccessRabbitsGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiEnvironmentAccessRabbitsGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiEnvironmentAccessRabbitsGetCollection200Response struct {
	value *ApiEnvironmentAccessRabbitsGetCollection200Response
	isSet bool
}

func (v NullableApiEnvironmentAccessRabbitsGetCollection200Response) Get() *ApiEnvironmentAccessRabbitsGetCollection200Response {
	return v.value
}

func (v *NullableApiEnvironmentAccessRabbitsGetCollection200Response) Set(val *ApiEnvironmentAccessRabbitsGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiEnvironmentAccessRabbitsGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiEnvironmentAccessRabbitsGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiEnvironmentAccessRabbitsGetCollection200Response(val *ApiEnvironmentAccessRabbitsGetCollection200Response) *NullableApiEnvironmentAccessRabbitsGetCollection200Response {
	return &NullableApiEnvironmentAccessRabbitsGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiEnvironmentAccessRabbitsGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiEnvironmentAccessRabbitsGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
