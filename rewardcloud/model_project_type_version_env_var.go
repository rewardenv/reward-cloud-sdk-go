...
func (o *ProjectTypeVersionEnvVar) GetEnvVarValidations() []string {
...
// and a boolean to check if the value has been set.
func (o *ProjectTypeVersionEnvVar) GetEnvVarValidationsOk() ([]string, bool) {
	if o == nil || IsNil(o.EnvVarValidations) {
		return nil, false
	}
...
func (o *ProjectTypeVersionEnvVar) HasEnvVarValidations() bool {
	if o != nil && !IsNil(o.EnvVarValidations) {
		return true
	}
...
func (o *ProjectTypeVersionEnvVar) SetEnvVarValidations(v []string) {
