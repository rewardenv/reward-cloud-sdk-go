...
// checks if the EnvironmentEnvVarJsonhalEnvironmentGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentEnvVarJsonhalEnvironmentGet{}

// EnvironmentEnvVarJsonhalEnvironmentGet 
type EnvironmentEnvVarJsonhalEnvironmentGet struct {
...
func NewEnvironmentEnvVarJsonhalEnvironmentGet() *EnvironmentEnvVarJsonhalEnvironmentGet {
	this := EnvironmentEnvVarJsonhalEnvironmentGet{}
	return &this
}
...
func (o *EnvironmentEnvVarJsonhalEnvironmentGet) SetLinks(v AbstractEnvironmentJsonhalLinks) {
	o.Links = &v
}
...
func (o *EnvironmentEnvVarJsonhalEnvironmentGet) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *EnvironmentEnvVarJsonhalEnvironmentGet) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *EnvironmentEnvVarJsonhalEnvironmentGet) SetIsEncryptedNil() {
...
func (o *EnvironmentEnvVarJsonhalEnvironmentGet) SetEnvVarTypeNil() {
...
func (o EnvironmentEnvVarJsonhalEnvironmentGet) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentEnvVarJsonhalEnvironmentGet) ToMap() (map[string]interface{}, error) {
...
type NullableEnvironmentEnvVarJsonhalEnvironmentGet struct {
	value *EnvironmentEnvVarJsonhalEnvironmentGet
	isSet bool
}

func (v NullableEnvironmentEnvVarJsonhalEnvironmentGet) Get() *EnvironmentEnvVarJsonhalEnvironmentGet {
	return v.value
}

func (v *NullableEnvironmentEnvVarJsonhalEnvironmentGet) Set(val *EnvironmentEnvVarJsonhalEnvironmentGet) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentEnvVarJsonhalEnvironmentGet) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentEnvVarJsonhalEnvironmentGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentEnvVarJsonhalEnvironmentGet(val *EnvironmentEnvVarJsonhalEnvironmentGet) *NullableEnvironmentEnvVarJsonhalEnvironmentGet {
	return &NullableEnvironmentEnvVarJsonhalEnvironmentGet{value: val, isSet: true}
}

func (v NullableEnvironmentEnvVarJsonhalEnvironmentGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentEnvVarJsonhalEnvironmentGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
