...
// checks if the EnvironmentComponentJsonhalTemplateEnvironmentOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentComponentJsonhalTemplateEnvironmentOutput{}

// EnvironmentComponentJsonhalTemplateEnvironmentOutput
type EnvironmentComponentJsonhalTemplateEnvironmentOutput struct {
...
func NewEnvironmentComponentJsonhalTemplateEnvironmentOutput() *EnvironmentComponentJsonhalTemplateEnvironmentOutput {
	this := EnvironmentComponentJsonhalTemplateEnvironmentOutput{}
	return &this
}
...
func (o *EnvironmentComponentJsonhalTemplateEnvironmentOutput) SetCpuNil() {
	o.Cpu.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *EnvironmentComponentJsonhalTemplateEnvironmentOutput) GetMemoryOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EnvironmentComponentJsonhalTemplateEnvironmentOutput) SetMemoryNil() {
	o.Memory.Set(nil)
}
...
func (o *EnvironmentComponentJsonhalTemplateEnvironmentOutput) SetStorageNil() {
	o.Storage.Set(nil)
}
...
func (o *EnvironmentComponentJsonhalTemplateEnvironmentOutput) SetNodeNil() {
	o.Node.Set(nil)
}
...
func (o *EnvironmentComponentJsonhalTemplateEnvironmentOutput) SetComponentVersionNil() {
...
func (o EnvironmentComponentJsonhalTemplateEnvironmentOutput) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentComponentJsonhalTemplateEnvironmentOutput) ToMap() (map[string]interface{}, error) {
...
type NullableEnvironmentComponentJsonhalTemplateEnvironmentOutput struct {
	value *EnvironmentComponentJsonhalTemplateEnvironmentOutput
	isSet bool
}

func (v NullableEnvironmentComponentJsonhalTemplateEnvironmentOutput) Get() *EnvironmentComponentJsonhalTemplateEnvironmentOutput {
	return v.value
}

func (v *NullableEnvironmentComponentJsonhalTemplateEnvironmentOutput) Set(val *EnvironmentComponentJsonhalTemplateEnvironmentOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentComponentJsonhalTemplateEnvironmentOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentComponentJsonhalTemplateEnvironmentOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentComponentJsonhalTemplateEnvironmentOutput(val *EnvironmentComponentJsonhalTemplateEnvironmentOutput) *NullableEnvironmentComponentJsonhalTemplateEnvironmentOutput {
	return &NullableEnvironmentComponentJsonhalTemplateEnvironmentOutput{value: val, isSet: true}
}

func (v NullableEnvironmentComponentJsonhalTemplateEnvironmentOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentComponentJsonhalTemplateEnvironmentOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
