...
// checks if the ExportedDataJsonhal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportedDataJsonhal{}
...
func (o ExportedDataJsonhal) ToMap() (map[string]interface{}, error) {
