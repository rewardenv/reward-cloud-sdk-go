...
// checks if the ApiProvidersGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiProvidersGetCollection200Response{}

// ApiProvidersGetCollection200Response struct for ApiProvidersGetCollection200Response
type ApiProvidersGetCollection200Response struct {
	Embedded []ProviderJsonhal `json:"_embedded"`
...
func NewApiProvidersGetCollection200Response(embedded []ProviderJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiProvidersGetCollection200Response {
	this := ApiProvidersGetCollection200Response{}
...
func (o ApiProvidersGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiProvidersGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiProvidersGetCollection200Response struct {
	value *ApiProvidersGetCollection200Response
	isSet bool
}

func (v NullableApiProvidersGetCollection200Response) Get() *ApiProvidersGetCollection200Response {
	return v.value
}

func (v *NullableApiProvidersGetCollection200Response) Set(val *ApiProvidersGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiProvidersGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiProvidersGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiProvidersGetCollection200Response(val *ApiProvidersGetCollection200Response) *NullableApiProvidersGetCollection200Response {
	return &NullableApiProvidersGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiProvidersGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiProvidersGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
