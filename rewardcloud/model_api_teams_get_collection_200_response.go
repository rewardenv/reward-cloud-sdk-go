...
// checks if the ApiTeamsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiTeamsGetCollection200Response{}
...
func (o ApiTeamsGetCollection200Response) ToMap() (map[string]interface{}, error) {
