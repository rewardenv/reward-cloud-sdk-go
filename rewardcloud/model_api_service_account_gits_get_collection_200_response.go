...
// checks if the ApiServiceAccountGitsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiServiceAccountGitsGetCollection200Response{}

// ApiServiceAccountGitsGetCollection200Response struct for ApiServiceAccountGitsGetCollection200Response
type ApiServiceAccountGitsGetCollection200Response struct {
	Embedded []ServiceAccountGitJsonhal `json:"_embedded"`
...
func NewApiServiceAccountGitsGetCollection200Response(embedded []ServiceAccountGitJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiServiceAccountGitsGetCollection200Response {
	this := ApiServiceAccountGitsGetCollection200Response{}
...
func (o *ApiServiceAccountGitsGetCollection200Response) GetEmbedded() []ServiceAccountGitJsonhal {
	if o == nil {
		var ret []ServiceAccountGitJsonhal
		return ret
	}
...
func (o ApiServiceAccountGitsGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiServiceAccountGitsGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiServiceAccountGitsGetCollection200Response struct {
	value *ApiServiceAccountGitsGetCollection200Response
	isSet bool
}

func (v NullableApiServiceAccountGitsGetCollection200Response) Get() *ApiServiceAccountGitsGetCollection200Response {
	return v.value
}

func (v *NullableApiServiceAccountGitsGetCollection200Response) Set(val *ApiServiceAccountGitsGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiServiceAccountGitsGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiServiceAccountGitsGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiServiceAccountGitsGetCollection200Response(val *ApiServiceAccountGitsGetCollection200Response) *NullableApiServiceAccountGitsGetCollection200Response {
	return &NullableApiServiceAccountGitsGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiServiceAccountGitsGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiServiceAccountGitsGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
