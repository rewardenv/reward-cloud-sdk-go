...
func (o *TeamEnvVarTeamGet) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *TeamEnvVarTeamGet) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *TeamEnvVarTeamGet) SetIsEncryptedNil() {
...
func (o *TeamEnvVarTeamGet) SetEnvVarTypeNil() {
...
type NullableTeamEnvVarTeamGet struct {
	value *TeamEnvVarTeamGet
	isSet bool
}

func (v NullableTeamEnvVarTeamGet) Get() *TeamEnvVarTeamGet {
	return v.value
}

func (v *NullableTeamEnvVarTeamGet) Set(val *TeamEnvVarTeamGet) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamEnvVarTeamGet) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamEnvVarTeamGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamEnvVarTeamGet(val *TeamEnvVarTeamGet) *NullableTeamEnvVarTeamGet {
	return &NullableTeamEnvVarTeamGet{value: val, isSet: true}
}

func (v NullableTeamEnvVarTeamGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamEnvVarTeamGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
