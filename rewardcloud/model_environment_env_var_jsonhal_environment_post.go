...
// checks if the EnvironmentEnvVarJsonhalEnvironmentPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentEnvVarJsonhalEnvironmentPost{}

// EnvironmentEnvVarJsonhalEnvironmentPost 
type EnvironmentEnvVarJsonhalEnvironmentPost struct {
...
func NewEnvironmentEnvVarJsonhalEnvironmentPost() *EnvironmentEnvVarJsonhalEnvironmentPost {
	this := EnvironmentEnvVarJsonhalEnvironmentPost{}
	return &this
}
...
func (o *EnvironmentEnvVarJsonhalEnvironmentPost) SetLinks(v AbstractEnvironmentJsonhalLinks) {
	o.Links = &v
}
...
func (o *EnvironmentEnvVarJsonhalEnvironmentPost) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *EnvironmentEnvVarJsonhalEnvironmentPost) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *EnvironmentEnvVarJsonhalEnvironmentPost) SetIsEncryptedNil() {
...
func (o *EnvironmentEnvVarJsonhalEnvironmentPost) SetEnvVarTypeNil() {
...
func (o EnvironmentEnvVarJsonhalEnvironmentPost) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentEnvVarJsonhalEnvironmentPost) ToMap() (map[string]interface{}, error) {
...
type NullableEnvironmentEnvVarJsonhalEnvironmentPost struct {
	value *EnvironmentEnvVarJsonhalEnvironmentPost
	isSet bool
}

func (v NullableEnvironmentEnvVarJsonhalEnvironmentPost) Get() *EnvironmentEnvVarJsonhalEnvironmentPost {
	return v.value
}

func (v *NullableEnvironmentEnvVarJsonhalEnvironmentPost) Set(val *EnvironmentEnvVarJsonhalEnvironmentPost) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentEnvVarJsonhalEnvironmentPost) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentEnvVarJsonhalEnvironmentPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentEnvVarJsonhalEnvironmentPost(val *EnvironmentEnvVarJsonhalEnvironmentPost) *NullableEnvironmentEnvVarJsonhalEnvironmentPost {
	return &NullableEnvironmentEnvVarJsonhalEnvironmentPost{value: val, isSet: true}
}

func (v NullableEnvironmentEnvVarJsonhalEnvironmentPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentEnvVarJsonhalEnvironmentPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
