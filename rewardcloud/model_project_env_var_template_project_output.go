...
// checks if the ProjectEnvVarTemplateProjectOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectEnvVarTemplateProjectOutput{}

// ProjectEnvVarTemplateProjectOutput
type ProjectEnvVarTemplateProjectOutput struct {
...
func NewProjectEnvVarTemplateProjectOutput() *ProjectEnvVarTemplateProjectOutput {
	this := ProjectEnvVarTemplateProjectOutput{}
	return &this
}
...
func (o *ProjectEnvVarTemplateProjectOutput) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *ProjectEnvVarTemplateProjectOutput) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *ProjectEnvVarTemplateProjectOutput) SetIsEncryptedNil() {
...
func (o *ProjectEnvVarTemplateProjectOutput) SetEnvVarTypeNil() {
...
func (o ProjectEnvVarTemplateProjectOutput) MarshalJSON() ([]byte, error) {
...
func (o ProjectEnvVarTemplateProjectOutput) ToMap() (map[string]interface{}, error) {
...
type NullableProjectEnvVarTemplateProjectOutput struct {
	value *ProjectEnvVarTemplateProjectOutput
	isSet bool
}

func (v NullableProjectEnvVarTemplateProjectOutput) Get() *ProjectEnvVarTemplateProjectOutput {
	return v.value
}

func (v *NullableProjectEnvVarTemplateProjectOutput) Set(val *ProjectEnvVarTemplateProjectOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectEnvVarTemplateProjectOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectEnvVarTemplateProjectOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectEnvVarTemplateProjectOutput(val *ProjectEnvVarTemplateProjectOutput) *NullableProjectEnvVarTemplateProjectOutput {
	return &NullableProjectEnvVarTemplateProjectOutput{value: val, isSet: true}
}

func (v NullableProjectEnvVarTemplateProjectOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectEnvVarTemplateProjectOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
