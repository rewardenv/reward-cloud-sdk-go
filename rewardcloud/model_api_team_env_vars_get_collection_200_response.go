...
// checks if the ApiTeamEnvVarsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiTeamEnvVarsGetCollection200Response{}
...
func (o ApiTeamEnvVarsGetCollection200Response) ToMap() (map[string]interface{}, error) {
