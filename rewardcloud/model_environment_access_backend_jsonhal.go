...
// checks if the EnvironmentAccessBackendJsonhal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentAccessBackendJsonhal{}

// EnvironmentAccessBackendJsonhal Class EnvironmentAccessBackend
type EnvironmentAccessBackendJsonhal struct {
...
func NewEnvironmentAccessBackendJsonhal() *EnvironmentAccessBackendJsonhal {
	this := EnvironmentAccessBackendJsonhal{}
	return &this
}
...
func (o *EnvironmentAccessBackendJsonhal) SetUuidNil() {
	o.Uuid.Set(nil)
}
...
func (o *EnvironmentAccessBackendJsonhal) SetUrlNil() {
	o.Url.Set(nil)
}
...
func (o *EnvironmentAccessBackendJsonhal) SetUsernameNil() {
	o.Username.Set(nil)
}
...
func (o *EnvironmentAccessBackendJsonhal) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *EnvironmentAccessBackendJsonhal) SetEnvironmentAccessNil() {
...
func (o *EnvironmentAccessBackendJsonhal) SetCreatedByNil() {
	o.CreatedBy.Set(nil)
}
...
func (o *EnvironmentAccessBackendJsonhal) SetUpdatedByNil() {
	o.UpdatedBy.Set(nil)
}
...
func (o EnvironmentAccessBackendJsonhal) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentAccessBackendJsonhal) ToMap() (map[string]interface{}, error) {
...
type NullableEnvironmentAccessBackendJsonhal struct {
	value *EnvironmentAccessBackendJsonhal
	isSet bool
}

func (v NullableEnvironmentAccessBackendJsonhal) Get() *EnvironmentAccessBackendJsonhal {
	return v.value
}

func (v *NullableEnvironmentAccessBackendJsonhal) Set(val *EnvironmentAccessBackendJsonhal) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentAccessBackendJsonhal) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentAccessBackendJsonhal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentAccessBackendJsonhal(val *EnvironmentAccessBackendJsonhal) *NullableEnvironmentAccessBackendJsonhal {
	return &NullableEnvironmentAccessBackendJsonhal{value: val, isSet: true}
}

func (v NullableEnvironmentAccessBackendJsonhal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentAccessBackendJsonhal) UnmarshalJSON(src []byte) error {
	v.isSet = true
