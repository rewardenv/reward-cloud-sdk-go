...
// checks if the ApiTemplateEnvironmentsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiTemplateEnvironmentsGetCollection200Response{}

// ApiTemplateEnvironmentsGetCollection200Response struct for ApiTemplateEnvironmentsGetCollection200Response
type ApiTemplateEnvironmentsGetCollection200Response struct {
	Embedded []TemplateEnvironmentJsonhalTemplateEnvironmentOutput `json:"_embedded"`
...
func NewApiTemplateEnvironmentsGetCollection200Response(embedded []TemplateEnvironmentJsonhalTemplateEnvironmentOutput, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiTemplateEnvironmentsGetCollection200Response {
	this := ApiTemplateEnvironmentsGetCollection200Response{}
...
func (o *ApiTemplateEnvironmentsGetCollection200Response) GetEmbedded() []TemplateEnvironmentJsonhalTemplateEnvironmentOutput {
	if o == nil {
		var ret []TemplateEnvironmentJsonhalTemplateEnvironmentOutput
		return ret
	}
...
func (o ApiTemplateEnvironmentsGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiTemplateEnvironmentsGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiTemplateEnvironmentsGetCollection200Response struct {
	value *ApiTemplateEnvironmentsGetCollection200Response
	isSet bool
}

func (v NullableApiTemplateEnvironmentsGetCollection200Response) Get() *ApiTemplateEnvironmentsGetCollection200Response {
	return v.value
}

func (v *NullableApiTemplateEnvironmentsGetCollection200Response) Set(val *ApiTemplateEnvironmentsGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiTemplateEnvironmentsGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiTemplateEnvironmentsGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiTemplateEnvironmentsGetCollection200Response(val *ApiTemplateEnvironmentsGetCollection200Response) *NullableApiTemplateEnvironmentsGetCollection200Response {
	return &NullableApiTemplateEnvironmentsGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiTemplateEnvironmentsGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiTemplateEnvironmentsGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
