...
// checks if the ApiEnvVarTypesGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiEnvVarTypesGetCollection200Response{}
...
func (o ApiEnvVarTypesGetCollection200Response) ToMap() (map[string]interface{}, error) {
