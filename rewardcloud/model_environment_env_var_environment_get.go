...
// checks if the EnvironmentEnvVarEnvironmentGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentEnvVarEnvironmentGet{}

// EnvironmentEnvVarEnvironmentGet
type EnvironmentEnvVarEnvironmentGet struct {
...
func NewEnvironmentEnvVarEnvironmentGet() *EnvironmentEnvVarEnvironmentGet {
	this := EnvironmentEnvVarEnvironmentGet{}
	return &this
}
...
func (o *EnvironmentEnvVarEnvironmentGet) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *EnvironmentEnvVarEnvironmentGet) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *EnvironmentEnvVarEnvironmentGet) SetIsEncryptedNil() {
...
func (o *EnvironmentEnvVarEnvironmentGet) SetEnvVarTypeNil() {
...
func (o EnvironmentEnvVarEnvironmentGet) MarshalJSON() ([]byte, error) {
...
func (o EnvironmentEnvVarEnvironmentGet) ToMap() (map[string]interface{}, error) {
...
type NullableEnvironmentEnvVarEnvironmentGet struct {
	value *EnvironmentEnvVarEnvironmentGet
	isSet bool
}

func (v NullableEnvironmentEnvVarEnvironmentGet) Get() *EnvironmentEnvVarEnvironmentGet {
	return v.value
}

func (v *NullableEnvironmentEnvVarEnvironmentGet) Set(val *EnvironmentEnvVarEnvironmentGet) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentEnvVarEnvironmentGet) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentEnvVarEnvironmentGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentEnvVarEnvironmentGet(val *EnvironmentEnvVarEnvironmentGet) *NullableEnvironmentEnvVarEnvironmentGet {
	return &NullableEnvironmentEnvVarEnvironmentGet{value: val, isSet: true}
}

func (v NullableEnvironmentEnvVarEnvironmentGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentEnvVarEnvironmentGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
