...
// checks if the ApiDataTransferTypesGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiDataTransferTypesGetCollection200Response{}

// ApiDataTransferTypesGetCollection200Response struct for ApiDataTransferTypesGetCollection200Response
type ApiDataTransferTypesGetCollection200Response struct {
	Embedded []DataTransferTypeJsonhal `json:"_embedded"`
...
func NewApiDataTransferTypesGetCollection200Response(embedded []DataTransferTypeJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiDataTransferTypesGetCollection200Response {
	this := ApiDataTransferTypesGetCollection200Response{}
...
func (o *ApiDataTransferTypesGetCollection200Response) GetEmbedded() []DataTransferTypeJsonhal {
	if o == nil {
		var ret []DataTransferTypeJsonhal
		return ret
	}
...
func (o ApiDataTransferTypesGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiDataTransferTypesGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiDataTransferTypesGetCollection200Response struct {
	value *ApiDataTransferTypesGetCollection200Response
	isSet bool
}

func (v NullableApiDataTransferTypesGetCollection200Response) Get() *ApiDataTransferTypesGetCollection200Response {
	return v.value
}

func (v *NullableApiDataTransferTypesGetCollection200Response) Set(val *ApiDataTransferTypesGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiDataTransferTypesGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiDataTransferTypesGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiDataTransferTypesGetCollection200Response(val *ApiDataTransferTypesGetCollection200Response) *NullableApiDataTransferTypesGetCollection200Response {
	return &NullableApiDataTransferTypesGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiDataTransferTypesGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiDataTransferTypesGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
