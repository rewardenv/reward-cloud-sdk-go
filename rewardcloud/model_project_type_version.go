...
type ProjectTypeVersion struct {
	...
	ComponentVersions        []string       `json:"componentVersions,omitempty"`
...
func (o *ProjectTypeVersion) GetRequiredComponent() []string {
...
// and a boolean to check if the value has been set.
func (o *ProjectTypeVersion) GetRequiredComponentOk() ([]string, bool) {
	if o == nil || IsNil(o.RequiredComponent) {
		return nil, false
	}
...
func (o *ProjectTypeVersion) HasRequiredComponent() bool {
	if o != nil && !IsNil(o.RequiredComponent) {
		return true
	}
...
func (o *ProjectTypeVersion) SetRequiredComponent(v []string) {
	o.RequiredComponent = v
}

// GetComponentVersions returns the ComponentVersions field value if set, zero value otherwise.
func (o *ProjectTypeVersion) GetComponentVersions() []string {
	if o == nil || IsNil(o.ComponentVersions) {
		var ret []string
		return ret
	}
	return o.ComponentVersions
}

// GetComponentVersionsOk returns a tuple with the ComponentVersions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectTypeVersion) GetComponentVersionsOk() ([]string, bool) {
	if o == nil || IsNil(o.ComponentVersions) {
		return nil, false
	}
	return o.ComponentVersions, true
}

// HasComponentVersions returns a boolean if a field has been set.
func (o *ProjectTypeVersion) HasComponentVersions() bool {
	if o != nil && !IsNil(o.ComponentVersions) {
		return true
	}
...
// SetComponentVersions gets a reference to the given []string and assigns it to the ComponentVersions field.
func (o *ProjectTypeVersion) SetComponentVersions(v []string) {
	o.ComponentVersions = v
}
...
func (o ProjectTypeVersion) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ComponentVersions) {
		toSerialize["componentVersions"] = o.ComponentVersions
	}
