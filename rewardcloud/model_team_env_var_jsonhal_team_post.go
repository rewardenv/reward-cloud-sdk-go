...
func NewTeamEnvVarJsonhalTeamPost() *TeamEnvVarJsonhalTeamPost {
	this := TeamEnvVarJsonhalTeamPost{}
	return &this
}
...
func (o *TeamEnvVarJsonhalTeamPost) GetLinks() ComponentJsonhalLinks {
...
func (o *TeamEnvVarJsonhalTeamPost) GetLinksOk() (*ComponentJsonhalLinks, bool) {
	if o == nil || isNil(o.Links) {
    return nil, false
	}
	return o.Links, true
...
func (o *TeamEnvVarJsonhalTeamPost) SetLinks(v ComponentJsonhalLinks) {
	o.Links = &v
}
...
type NullableTeamEnvVarJsonhalTeamPost struct {
	value *TeamEnvVarJsonhalTeamPost
	isSet bool
}

func (v NullableTeamEnvVarJsonhalTeamPost) Get() *TeamEnvVarJsonhalTeamPost {
	return v.value
}

func (v *NullableTeamEnvVarJsonhalTeamPost) Set(val *TeamEnvVarJsonhalTeamPost) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamEnvVarJsonhalTeamPost) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamEnvVarJsonhalTeamPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamEnvVarJsonhalTeamPost(val *TeamEnvVarJsonhalTeamPost) *NullableTeamEnvVarJsonhalTeamPost {
	return &NullableTeamEnvVarJsonhalTeamPost{value: val, isSet: true}
}

func (v NullableTeamEnvVarJsonhalTeamPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamEnvVarJsonhalTeamPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
