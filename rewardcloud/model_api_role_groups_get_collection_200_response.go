...
// checks if the ApiRoleGroupsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiRoleGroupsGetCollection200Response{}

// ApiRoleGroupsGetCollection200Response struct for ApiRoleGroupsGetCollection200Response
type ApiRoleGroupsGetCollection200Response struct {
	Embedded []RoleGroupJsonhal `json:"_embedded"`
...
func NewApiRoleGroupsGetCollection200Response(embedded []RoleGroupJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiRoleGroupsGetCollection200Response {
	this := ApiRoleGroupsGetCollection200Response{}
...
func (o ApiRoleGroupsGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiRoleGroupsGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiRoleGroupsGetCollection200Response struct {
	value *ApiRoleGroupsGetCollection200Response
	isSet bool
}

func (v NullableApiRoleGroupsGetCollection200Response) Get() *ApiRoleGroupsGetCollection200Response {
	return v.value
}

func (v *NullableApiRoleGroupsGetCollection200Response) Set(val *ApiRoleGroupsGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiRoleGroupsGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiRoleGroupsGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiRoleGroupsGetCollection200Response(val *ApiRoleGroupsGetCollection200Response) *NullableApiRoleGroupsGetCollection200Response {
	return &NullableApiRoleGroupsGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiRoleGroupsGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiRoleGroupsGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
