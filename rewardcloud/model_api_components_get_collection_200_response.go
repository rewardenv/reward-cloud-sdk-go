...
// checks if the ApiComponentsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiComponentsGetCollection200Response{}

// ApiComponentsGetCollection200Response struct for ApiComponentsGetCollection200Response
type ApiComponentsGetCollection200Response struct {
	Embedded []ComponentJsonhal `json:"_embedded"`
...
func NewApiComponentsGetCollection200Response(embedded []ComponentJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiComponentsGetCollection200Response {
	this := ApiComponentsGetCollection200Response{}
...
func (o ApiComponentsGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiComponentsGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiComponentsGetCollection200Response struct {
	value *ApiComponentsGetCollection200Response
	isSet bool
}

func (v NullableApiComponentsGetCollection200Response) Get() *ApiComponentsGetCollection200Response {
	return v.value
}

func (v *NullableApiComponentsGetCollection200Response) Set(val *ApiComponentsGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiComponentsGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiComponentsGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiComponentsGetCollection200Response(val *ApiComponentsGetCollection200Response) *NullableApiComponentsGetCollection200Response {
	return &NullableApiComponentsGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiComponentsGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiComponentsGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
