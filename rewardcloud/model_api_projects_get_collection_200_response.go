...
// checks if the ApiProjectsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiProjectsGetCollection200Response{}

// ApiProjectsGetCollection200Response struct for ApiProjectsGetCollection200Response
type ApiProjectsGetCollection200Response struct {
	Embedded []ProjectJsonhalProjectGet `json:"_embedded"`
...
func NewApiProjectsGetCollection200Response(embedded []ProjectJsonhalProjectGet, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiProjectsGetCollection200Response {
	this := ApiProjectsGetCollection200Response{}
...
func (o *ApiProjectsGetCollection200Response) GetEmbedded() []ProjectJsonhalProjectGet {
	if o == nil {
		var ret []ProjectJsonhalProjectGet
		return ret
	}
...
func (o ApiProjectsGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiProjectsGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiProjectsGetCollection200Response struct {
	value *ApiProjectsGetCollection200Response
	isSet bool
}

func (v NullableApiProjectsGetCollection200Response) Get() *ApiProjectsGetCollection200Response {
	return v.value
}

func (v *NullableApiProjectsGetCollection200Response) Set(val *ApiProjectsGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiProjectsGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiProjectsGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiProjectsGetCollection200Response(val *ApiProjectsGetCollection200Response) *NullableApiProjectsGetCollection200Response {
	return &NullableApiProjectsGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiProjectsGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiProjectsGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
