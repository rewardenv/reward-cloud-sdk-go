...
// checks if the ExportedData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportedData{}
...
func (o *ExportedData) GetIsStripDatabase() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ExportedData) GetIsStripDatabaseOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ExportedData) HasIsStripDatabase() bool {
...
func (o *ExportedData) UnsetIsStripDatabase() {
...
func (o ExportedData) ToMap() (map[string]interface{}, error) {
