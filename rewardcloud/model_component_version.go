...
type ComponentVersion struct {
	...
	ProjectTypeVersions    []string          `json:"projectTypeVersions,omitempty"`
...
// GetProjectTypeVersions returns the ProjectTypeVersions field value if set, zero value otherwise.
func (o *ComponentVersion) GetProjectTypeVersions() []string {
	if o == nil || IsNil(o.ProjectTypeVersions) {
		var ret []string
		return ret
	}
	return o.ProjectTypeVersions
}

// GetProjectTypeVersionsOk returns a tuple with the ProjectTypeVersions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ComponentVersion) GetProjectTypeVersionsOk() ([]string, bool) {
	if o == nil || IsNil(o.ProjectTypeVersions) {
		return nil, false
	}
	return o.ProjectTypeVersions, true
}

// HasProjectTypeVersions returns a boolean if a field has been set.
func (o *ComponentVersion) HasProjectTypeVersions() bool {
	if o != nil && !IsNil(o.ProjectTypeVersions) {
		return true
	}
...
// SetProjectTypeVersions gets a reference to the given []string and assigns it to the ProjectTypeVersions field.
func (o *ComponentVersion) SetProjectTypeVersions(v []string) {
	o.ProjectTypeVersions = v
}
...
func (o ComponentVersion) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ProjectTypeVersions) {
		toSerialize["projectTypeVersions"] = o.ProjectTypeVersions
	}
