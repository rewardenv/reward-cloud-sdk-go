...
// checks if the ApiProjectTypeVersionEnvVarExamplesGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiProjectTypeVersionEnvVarExamplesGetCollection200Response{}
...
func (o ApiProjectTypeVersionEnvVarExamplesGetCollection200Response) ToMap() (map[string]interface{}, error) {
