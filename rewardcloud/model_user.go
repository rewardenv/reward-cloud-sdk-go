...
type User struct {
	...
	PasswordReset   NullableString `json:"passwordReset,omitempty"`
...
// GetPasswordReset returns the PasswordReset field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *User) GetPasswordReset() string {
	if o == nil || IsNil(o.PasswordReset.Get()) {
		var ret string
		return ret
	}
	return *o.PasswordReset.Get()
}

// GetPasswordResetOk returns a tuple with the PasswordReset field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *User) GetPasswordResetOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return o.PasswordReset.Get(), o.PasswordReset.IsSet()
}

// HasPasswordReset returns a boolean if a field has been set.
func (o *User) HasPasswordReset() bool {
	if o != nil && o.PasswordReset.IsSet() {
		return true
	}
...
// SetPasswordReset gets a reference to the given NullableString and assigns it to the PasswordReset field.
func (o *User) SetPasswordReset(v string) {
	o.PasswordReset.Set(&v)
}

// SetPasswordResetNil sets the value for PasswordReset to be an explicit nil
func (o *User) SetPasswordResetNil() {
	o.PasswordReset.Set(nil)
}

// UnsetPasswordReset ensures that no value is present for PasswordReset, not even an explicit nil
func (o *User) UnsetPasswordReset() {
	o.PasswordReset.Unset()
}
...
func (o User) ToMap() (map[string]interface{}, error) {
	...
	if o.PasswordReset.IsSet() {
		toSerialize["passwordReset"] = o.PasswordReset.Get()
	}
