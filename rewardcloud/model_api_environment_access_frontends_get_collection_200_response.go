...
// checks if the ApiEnvironmentAccessFrontendsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiEnvironmentAccessFrontendsGetCollection200Response{}

// ApiEnvironmentAccessFrontendsGetCollection200Response struct for ApiEnvironmentAccessFrontendsGetCollection200Response
type ApiEnvironmentAccessFrontendsGetCollection200Response struct {
	Embedded []EnvironmentAccessFrontendJsonhal `json:"_embedded"`
...
func NewApiEnvironmentAccessFrontendsGetCollection200Response(embedded []EnvironmentAccessFrontendJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiEnvironmentAccessFrontendsGetCollection200Response {
	this := ApiEnvironmentAccessFrontendsGetCollection200Response{}
...
func (o *ApiEnvironmentAccessFrontendsGetCollection200Response) GetEmbedded() []EnvironmentAccessFrontendJsonhal {
	if o == nil {
		var ret []EnvironmentAccessFrontendJsonhal
		return ret
	}
...
func (o ApiEnvironmentAccessFrontendsGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiEnvironmentAccessFrontendsGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiEnvironmentAccessFrontendsGetCollection200Response struct {
	value *ApiEnvironmentAccessFrontendsGetCollection200Response
	isSet bool
}

func (v NullableApiEnvironmentAccessFrontendsGetCollection200Response) Get() *ApiEnvironmentAccessFrontendsGetCollection200Response {
	return v.value
}

func (v *NullableApiEnvironmentAccessFrontendsGetCollection200Response) Set(val *ApiEnvironmentAccessFrontendsGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiEnvironmentAccessFrontendsGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiEnvironmentAccessFrontendsGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiEnvironmentAccessFrontendsGetCollection200Response(val *ApiEnvironmentAccessFrontendsGetCollection200Response) *NullableApiEnvironmentAccessFrontendsGetCollection200Response {
	return &NullableApiEnvironmentAccessFrontendsGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiEnvironmentAccessFrontendsGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiEnvironmentAccessFrontendsGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
