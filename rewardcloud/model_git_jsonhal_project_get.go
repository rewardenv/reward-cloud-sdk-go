...
// SetGitType gets a reference to the given NullableGitJsonhalProjectGetGitType and assigns it to the GitType field.
...
// SetCredentialType gets a reference to the given NullableGitJsonhalProjectGetCredentialType and assigns it to the CredentialType field.
...
type NullableGitJsonhalProjectGet struct {
	value *GitJsonhalProjectGet
	isSet bool
}

func (v NullableGitJsonhalProjectGet) Get() *GitJsonhalProjectGet {
	return v.value
}

func (v *NullableGitJsonhalProjectGet) Set(val *GitJsonhalProjectGet) {
	v.value = val
	v.isSet = true
}

func (v NullableGitJsonhalProjectGet) IsSet() bool {
	return v.isSet
}

func (v *NullableGitJsonhalProjectGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGitJsonhalProjectGet(val *GitJsonhalProjectGet) *NullableGitJsonhalProjectGet {
	return &NullableGitJsonhalProjectGet{value: val, isSet: true}
}

func (v NullableGitJsonhalProjectGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGitJsonhalProjectGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
