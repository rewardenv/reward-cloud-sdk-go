...
// checks if the EnvironmentAccessFrontendJsonhal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentAccessFrontendJsonhal{}
...
func (o EnvironmentAccessFrontendJsonhal) ToMap() (map[string]interface{}, error) {
