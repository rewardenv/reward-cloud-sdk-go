...
// checks if the ApiEnvironmentAccessesGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiEnvironmentAccessesGetCollection200Response{}

// ApiEnvironmentAccessesGetCollection200Response struct for ApiEnvironmentAccessesGetCollection200Response
type ApiEnvironmentAccessesGetCollection200Response struct {
	Embedded []EnvironmentAccessJsonhal `json:"_embedded"`
...
func NewApiEnvironmentAccessesGetCollection200Response(embedded []EnvironmentAccessJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiEnvironmentAccessesGetCollection200Response {
	this := ApiEnvironmentAccessesGetCollection200Response{}
...
func (o *ApiEnvironmentAccessesGetCollection200Response) GetEmbedded() []EnvironmentAccessJsonhal {
	if o == nil {
		var ret []EnvironmentAccessJsonhal
		return ret
	}
...
func (o ApiEnvironmentAccessesGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiEnvironmentAccessesGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiEnvironmentAccessesGetCollection200Response struct {
	value *ApiEnvironmentAccessesGetCollection200Response
	isSet bool
}

func (v NullableApiEnvironmentAccessesGetCollection200Response) Get() *ApiEnvironmentAccessesGetCollection200Response {
	return v.value
}

func (v *NullableApiEnvironmentAccessesGetCollection200Response) Set(val *ApiEnvironmentAccessesGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiEnvironmentAccessesGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiEnvironmentAccessesGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiEnvironmentAccessesGetCollection200Response(val *ApiEnvironmentAccessesGetCollection200Response) *NullableApiEnvironmentAccessesGetCollection200Response {
	return &NullableApiEnvironmentAccessesGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiEnvironmentAccessesGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiEnvironmentAccessesGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
