...
func (o *ProjectType) SetCodeNameNil() {
	o.CodeName.Set(nil)
}
...
func (o *ProjectType) SetCreatedByNil() {
	o.CreatedBy.Set(nil)
}
...
func (o *ProjectType) SetUpdatedByNil() {
	o.UpdatedBy.Set(nil)
}
