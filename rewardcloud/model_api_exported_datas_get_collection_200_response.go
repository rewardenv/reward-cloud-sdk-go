...
// checks if the ApiExportedDatasGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiExportedDatasGetCollection200Response{}

// ApiExportedDatasGetCollection200Response struct for ApiExportedDatasGetCollection200Response
type ApiExportedDatasGetCollection200Response struct {
	Embedded []ExportedDataJsonhal `json:"_embedded"`
...
func NewApiExportedDatasGetCollection200Response(embedded []ExportedDataJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiExportedDatasGetCollection200Response {
	this := ApiExportedDatasGetCollection200Response{}
...
func (o ApiExportedDatasGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiExportedDatasGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiExportedDatasGetCollection200Response struct {
	value *ApiExportedDatasGetCollection200Response
	isSet bool
}

func (v NullableApiExportedDatasGetCollection200Response) Get() *ApiExportedDatasGetCollection200Response {
	return v.value
}

func (v *NullableApiExportedDatasGetCollection200Response) Set(val *ApiExportedDatasGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiExportedDatasGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiExportedDatasGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiExportedDatasGetCollection200Response(val *ApiExportedDatasGetCollection200Response) *NullableApiExportedDatasGetCollection200Response {
	return &NullableApiExportedDatasGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiExportedDatasGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiExportedDatasGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
