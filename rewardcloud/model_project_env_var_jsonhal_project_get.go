...
func (o *ProjectEnvVarJsonhalProjectGet) GetLinks() ComponentJsonhalLinks {
...
func (o *ProjectEnvVarJsonhalProjectGet) GetLinksOk() (*ComponentJsonhalLinks, bool) {
	if o == nil || isNil(o.Links) {
    return nil, false
	}
	return o.Links, true
...
func (o *ProjectEnvVarJsonhalProjectGet) SetLinks(v ComponentJsonhalLinks) {
	o.Links = &v
}
