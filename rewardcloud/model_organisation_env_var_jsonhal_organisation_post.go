...
func NewOrganisationEnvVarJsonhalOrganisationPost() *OrganisationEnvVarJsonhalOrganisationPost {
	this := OrganisationEnvVarJsonhalOrganisationPost{}
	return &this
}
...
func (o *OrganisationEnvVarJsonhalOrganisationPost) GetLinks() ComponentJsonhalLinks {
...
func (o *OrganisationEnvVarJsonhalOrganisationPost) GetLinksOk() (*ComponentJsonhalLinks, bool) {
	if o == nil || isNil(o.Links) {
    return nil, false
	}
	return o.Links, true
...
func (o *OrganisationEnvVarJsonhalOrganisationPost) SetLinks(v ComponentJsonhalLinks) {
	o.Links = &v
}
...
func (o *OrganisationEnvVarJsonhalOrganisationPost) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *OrganisationEnvVarJsonhalOrganisationPost) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *OrganisationEnvVarJsonhalOrganisationPost) SetIsEncryptedNil() {
...
func (o *OrganisationEnvVarJsonhalOrganisationPost) SetEnvVarTypeNil() {
...
type NullableOrganisationEnvVarJsonhalOrganisationPost struct {
	value *OrganisationEnvVarJsonhalOrganisationPost
	isSet bool
}

func (v NullableOrganisationEnvVarJsonhalOrganisationPost) Get() *OrganisationEnvVarJsonhalOrganisationPost {
	return v.value
}

func (v *NullableOrganisationEnvVarJsonhalOrganisationPost) Set(val *OrganisationEnvVarJsonhalOrganisationPost) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganisationEnvVarJsonhalOrganisationPost) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganisationEnvVarJsonhalOrganisationPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganisationEnvVarJsonhalOrganisationPost(val *OrganisationEnvVarJsonhalOrganisationPost) *NullableOrganisationEnvVarJsonhalOrganisationPost {
	return &NullableOrganisationEnvVarJsonhalOrganisationPost{value: val, isSet: true}
}

func (v NullableOrganisationEnvVarJsonhalOrganisationPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganisationEnvVarJsonhalOrganisationPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
