...
// checks if the ProjectEnvVarProjectGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectEnvVarProjectGet{}

// ProjectEnvVarProjectGet 
type ProjectEnvVarProjectGet struct {
...
func (o *ProjectEnvVarProjectGet) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *ProjectEnvVarProjectGet) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *ProjectEnvVarProjectGet) SetIsEncryptedNil() {
...
func (o *ProjectEnvVarProjectGet) SetEnvVarTypeNil() {
...
func (o ProjectEnvVarProjectGet) MarshalJSON() ([]byte, error) {
...
func (o ProjectEnvVarProjectGet) ToMap() (map[string]interface{}, error) {
...
type NullableProjectEnvVarProjectGet struct {
	value *ProjectEnvVarProjectGet
	isSet bool
}

func (v NullableProjectEnvVarProjectGet) Get() *ProjectEnvVarProjectGet {
	return v.value
}

func (v *NullableProjectEnvVarProjectGet) Set(val *ProjectEnvVarProjectGet) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectEnvVarProjectGet) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectEnvVarProjectGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectEnvVarProjectGet(val *ProjectEnvVarProjectGet) *NullableProjectEnvVarProjectGet {
	return &NullableProjectEnvVarProjectGet{value: val, isSet: true}
}

func (v NullableProjectEnvVarProjectGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectEnvVarProjectGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
