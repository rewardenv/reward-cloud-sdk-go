...
func NewEnvironmentEnvVarJsonhalTemplateEnvironmentInput() *EnvironmentEnvVarJsonhalTemplateEnvironmentInput {
	this := EnvironmentEnvVarJsonhalTemplateEnvironmentInput{}
	return &this
}
...
func (o *EnvironmentEnvVarJsonhalTemplateEnvironmentInput) SetKeyNil() {
	o.Key.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *EnvironmentEnvVarJsonhalTemplateEnvironmentInput) GetValueOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EnvironmentEnvVarJsonhalTemplateEnvironmentInput) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *EnvironmentEnvVarJsonhalTemplateEnvironmentInput) SetIsEncryptedNil() {
...
func (o *EnvironmentEnvVarJsonhalTemplateEnvironmentInput) SetEnvVarTypeNil() {
...
type NullableEnvironmentEnvVarJsonhalTemplateEnvironmentInput struct {
	value *EnvironmentEnvVarJsonhalTemplateEnvironmentInput
	isSet bool
}

func (v NullableEnvironmentEnvVarJsonhalTemplateEnvironmentInput) Get() *EnvironmentEnvVarJsonhalTemplateEnvironmentInput {
	return v.value
}

func (v *NullableEnvironmentEnvVarJsonhalTemplateEnvironmentInput) Set(val *EnvironmentEnvVarJsonhalTemplateEnvironmentInput) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentEnvVarJsonhalTemplateEnvironmentInput) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentEnvVarJsonhalTemplateEnvironmentInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentEnvVarJsonhalTemplateEnvironmentInput(val *EnvironmentEnvVarJsonhalTemplateEnvironmentInput) *NullableEnvironmentEnvVarJsonhalTemplateEnvironmentInput {
	return &NullableEnvironmentEnvVarJsonhalTemplateEnvironmentInput{value: val, isSet: true}
}

func (v NullableEnvironmentEnvVarJsonhalTemplateEnvironmentInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentEnvVarJsonhalTemplateEnvironmentInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
