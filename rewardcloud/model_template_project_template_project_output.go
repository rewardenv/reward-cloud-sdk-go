...
func (o *TemplateProjectTemplateProjectOutput) GetCodeName() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TemplateProjectTemplateProjectOutput) GetCodeNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TemplateProjectTemplateProjectOutput) HasCodeName() bool {
...
func (o *TemplateProjectTemplateProjectOutput) SetCodeName(v string) {
	o.CodeName.Set(&v)
}

// SetCodeNameNil sets the value for CodeName to be an explicit nil
func (o *TemplateProjectTemplateProjectOutput) SetCodeNameNil() {
	o.CodeName.Set(nil)
}

// UnsetCodeName ensures that no value is present for CodeName, not even an explicit nil
func (o *TemplateProjectTemplateProjectOutput) UnsetCodeName() {
	o.CodeName.Unset()
}
