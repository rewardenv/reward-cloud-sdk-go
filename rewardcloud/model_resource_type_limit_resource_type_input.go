...
// checks if the ResourceTypeLimitResourceTypeInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceTypeLimitResourceTypeInput{}

// ResourceTypeLimitResourceTypeInput Class ResourceTypeLimit
type ResourceTypeLimitResourceTypeInput struct {
...
func NewResourceTypeLimitResourceTypeInput() *ResourceTypeLimitResourceTypeInput {
	this := ResourceTypeLimitResourceTypeInput{}
	return &this
}
...
func (o *ResourceTypeLimitResourceTypeInput) SetProjectMinValueNil() {
...
func (o *ResourceTypeLimitResourceTypeInput) SetProjectMaxValueNil() {
...
func (o *ResourceTypeLimitResourceTypeInput) SetEnvironmentMinValueNil() {
...
func (o *ResourceTypeLimitResourceTypeInput) SetEnvironmentMaxValueNil() {
...
func (o *ResourceTypeLimitResourceTypeInput) SetComponentMinValueNil() {
...
func (o *ResourceTypeLimitResourceTypeInput) SetComponentMaxValueNil() {
...
func (o ResourceTypeLimitResourceTypeInput) MarshalJSON() ([]byte, error) {
...
func (o ResourceTypeLimitResourceTypeInput) ToMap() (map[string]interface{}, error) {
...
type NullableResourceTypeLimitResourceTypeInput struct {
	value *ResourceTypeLimitResourceTypeInput
	isSet bool
}

func (v NullableResourceTypeLimitResourceTypeInput) Get() *ResourceTypeLimitResourceTypeInput {
	return v.value
}

func (v *NullableResourceTypeLimitResourceTypeInput) Set(val *ResourceTypeLimitResourceTypeInput) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceTypeLimitResourceTypeInput) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceTypeLimitResourceTypeInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceTypeLimitResourceTypeInput(val *ResourceTypeLimitResourceTypeInput) *NullableResourceTypeLimitResourceTypeInput {
	return &NullableResourceTypeLimitResourceTypeInput{value: val, isSet: true}
}

func (v NullableResourceTypeLimitResourceTypeInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceTypeLimitResourceTypeInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
