...
// checks if the ApiOrganisationsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiOrganisationsGetCollection200Response{}

// ApiOrganisationsGetCollection200Response struct for ApiOrganisationsGetCollection200Response
type ApiOrganisationsGetCollection200Response struct {
	Embedded []OrganisationJsonhalOrganisationGet `json:"_embedded"`
...
func NewApiOrganisationsGetCollection200Response(embedded []OrganisationJsonhalOrganisationGet, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiOrganisationsGetCollection200Response {
	this := ApiOrganisationsGetCollection200Response{}
...
func (o *ApiOrganisationsGetCollection200Response) GetEmbedded() []OrganisationJsonhalOrganisationGet {
	if o == nil {
		var ret []OrganisationJsonhalOrganisationGet
		return ret
	}
...
func (o ApiOrganisationsGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiOrganisationsGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiOrganisationsGetCollection200Response struct {
	value *ApiOrganisationsGetCollection200Response
	isSet bool
}

func (v NullableApiOrganisationsGetCollection200Response) Get() *ApiOrganisationsGetCollection200Response {
	return v.value
}

func (v *NullableApiOrganisationsGetCollection200Response) Set(val *ApiOrganisationsGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiOrganisationsGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiOrganisationsGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiOrganisationsGetCollection200Response(val *ApiOrganisationsGetCollection200Response) *NullableApiOrganisationsGetCollection200Response {
	return &NullableApiOrganisationsGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiOrganisationsGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiOrganisationsGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
