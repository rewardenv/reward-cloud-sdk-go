...
// checks if the ApiUsersGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiUsersGetCollection200Response{}

// ApiUsersGetCollection200Response struct for ApiUsersGetCollection200Response
type ApiUsersGetCollection200Response struct {
	Embedded []UserJsonhal `json:"_embedded"`
...
func NewApiUsersGetCollection200Response(embedded []UserJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiUsersGetCollection200Response {
	this := ApiUsersGetCollection200Response{}
...
func (o ApiUsersGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiUsersGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiUsersGetCollection200Response struct {
	value *ApiUsersGetCollection200Response
	isSet bool
}

func (v NullableApiUsersGetCollection200Response) Get() *ApiUsersGetCollection200Response {
	return v.value
}

func (v *NullableApiUsersGetCollection200Response) Set(val *ApiUsersGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiUsersGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiUsersGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiUsersGetCollection200Response(val *ApiUsersGetCollection200Response) *NullableApiUsersGetCollection200Response {
	return &NullableApiUsersGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiUsersGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiUsersGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
