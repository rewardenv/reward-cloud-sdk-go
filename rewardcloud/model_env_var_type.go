...
type EnvVarType struct {
	...
	EnvVar    []AbstractEnvVar `json:"envVar,omitempty"`
...
func (o *EnvVarType) GetEnvVar() []AbstractEnvVar {
	if o == nil || IsNil(o.EnvVar) {
		var ret []AbstractEnvVar
		return ret
	}
	return o.EnvVar
}
...
// and a boolean to check if the value has been set.
func (o *EnvVarType) GetEnvVarOk() ([]AbstractEnvVar, bool) {
	if o == nil || IsNil(o.EnvVar) {
		return nil, false
	}
...
func (o *EnvVarType) HasEnvVar() bool {
	if o != nil && !IsNil(o.EnvVar) {
		return true
	}
...
// SetEnvVar gets a reference to the given []AbstractEnvVar and assigns it to the EnvVar field.
func (o *EnvVarType) SetEnvVar(v []AbstractEnvVar) {
	o.EnvVar = v
}
