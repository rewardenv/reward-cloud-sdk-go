...
// checks if the GitTypeJsonhalProjectGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GitTypeJsonhalProjectGet{}

// GitTypeJsonhalProjectGet
type GitTypeJsonhalProjectGet struct {
...
func (o *GitTypeJsonhalProjectGet) SetUuidNil() {
	o.Uuid.Set(nil)
}
...
func (o *GitTypeJsonhalProjectGet) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o GitTypeJsonhalProjectGet) MarshalJSON() ([]byte, error) {
...
func (o GitTypeJsonhalProjectGet) ToMap() (map[string]interface{}, error) {
...
type NullableGitTypeJsonhalProjectGet struct {
	value *GitTypeJsonhalProjectGet
	isSet bool
}

func (v NullableGitTypeJsonhalProjectGet) Get() *GitTypeJsonhalProjectGet {
	return v.value
}

func (v *NullableGitTypeJsonhalProjectGet) Set(val *GitTypeJsonhalProjectGet) {
	v.value = val
	v.isSet = true
}

func (v NullableGitTypeJsonhalProjectGet) IsSet() bool {
	return v.isSet
}

func (v *NullableGitTypeJsonhalProjectGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGitTypeJsonhalProjectGet(val *GitTypeJsonhalProjectGet) *NullableGitTypeJsonhalProjectGet {
	return &NullableGitTypeJsonhalProjectGet{value: val, isSet: true}
}

func (v NullableGitTypeJsonhalProjectGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGitTypeJsonhalProjectGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
