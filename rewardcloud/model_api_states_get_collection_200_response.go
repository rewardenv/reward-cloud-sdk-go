...
// checks if the ApiStatesGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiStatesGetCollection200Response{}

// ApiStatesGetCollection200Response struct for ApiStatesGetCollection200Response
type ApiStatesGetCollection200Response struct {
	Embedded []StateJsonhal `json:"_embedded"`
...
func NewApiStatesGetCollection200Response(embedded []StateJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiStatesGetCollection200Response {
	this := ApiStatesGetCollection200Response{}
...
func (o ApiStatesGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiStatesGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiStatesGetCollection200Response struct {
	value *ApiStatesGetCollection200Response
	isSet bool
}

func (v NullableApiStatesGetCollection200Response) Get() *ApiStatesGetCollection200Response {
	return v.value
}

func (v *NullableApiStatesGetCollection200Response) Set(val *ApiStatesGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiStatesGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiStatesGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiStatesGetCollection200Response(val *ApiStatesGetCollection200Response) *NullableApiStatesGetCollection200Response {
	return &NullableApiStatesGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiStatesGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiStatesGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
