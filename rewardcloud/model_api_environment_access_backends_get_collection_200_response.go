...
// checks if the ApiEnvironmentAccessBackendsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiEnvironmentAccessBackendsGetCollection200Response{}

// ApiEnvironmentAccessBackendsGetCollection200Response struct for ApiEnvironmentAccessBackendsGetCollection200Response
type ApiEnvironmentAccessBackendsGetCollection200Response struct {
	Embedded []EnvironmentAccessBackendJsonhal `json:"_embedded"`
...
func NewApiEnvironmentAccessBackendsGetCollection200Response(embedded []EnvironmentAccessBackendJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiEnvironmentAccessBackendsGetCollection200Response {
	this := ApiEnvironmentAccessBackendsGetCollection200Response{}
...
func (o *ApiEnvironmentAccessBackendsGetCollection200Response) GetEmbedded() []EnvironmentAccessBackendJsonhal {
	if o == nil {
		var ret []EnvironmentAccessBackendJsonhal
		return ret
	}
...
func (o ApiEnvironmentAccessBackendsGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiEnvironmentAccessBackendsGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiEnvironmentAccessBackendsGetCollection200Response struct {
	value *ApiEnvironmentAccessBackendsGetCollection200Response
	isSet bool
}

func (v NullableApiEnvironmentAccessBackendsGetCollection200Response) Get() *ApiEnvironmentAccessBackendsGetCollection200Response {
	return v.value
}

func (v *NullableApiEnvironmentAccessBackendsGetCollection200Response) Set(val *ApiEnvironmentAccessBackendsGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiEnvironmentAccessBackendsGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiEnvironmentAccessBackendsGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiEnvironmentAccessBackendsGetCollection200Response(val *ApiEnvironmentAccessBackendsGetCollection200Response) *NullableApiEnvironmentAccessBackendsGetCollection200Response {
	return &NullableApiEnvironmentAccessBackendsGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiEnvironmentAccessBackendsGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiEnvironmentAccessBackendsGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
