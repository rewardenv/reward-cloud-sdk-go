...
// checks if the OrganisationEnvVarOrganisationPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrganisationEnvVarOrganisationPost{}

// OrganisationEnvVarOrganisationPost 
type OrganisationEnvVarOrganisationPost struct {
...
func NewOrganisationEnvVarOrganisationPost() *OrganisationEnvVarOrganisationPost {
	this := OrganisationEnvVarOrganisationPost{}
	return &this
}
...
func (o *OrganisationEnvVarOrganisationPost) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *OrganisationEnvVarOrganisationPost) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *OrganisationEnvVarOrganisationPost) SetIsEncryptedNil() {
...
func (o *OrganisationEnvVarOrganisationPost) SetEnvVarTypeNil() {
...
func (o OrganisationEnvVarOrganisationPost) MarshalJSON() ([]byte, error) {
...
func (o OrganisationEnvVarOrganisationPost) ToMap() (map[string]interface{}, error) {
...
type NullableOrganisationEnvVarOrganisationPost struct {
	value *OrganisationEnvVarOrganisationPost
	isSet bool
}

func (v NullableOrganisationEnvVarOrganisationPost) Get() *OrganisationEnvVarOrganisationPost {
	return v.value
}

func (v *NullableOrganisationEnvVarOrganisationPost) Set(val *OrganisationEnvVarOrganisationPost) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganisationEnvVarOrganisationPost) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganisationEnvVarOrganisationPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganisationEnvVarOrganisationPost(val *OrganisationEnvVarOrganisationPost) *NullableOrganisationEnvVarOrganisationPost {
	return &NullableOrganisationEnvVarOrganisationPost{value: val, isSet: true}
}

func (v NullableOrganisationEnvVarOrganisationPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganisationEnvVarOrganisationPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
