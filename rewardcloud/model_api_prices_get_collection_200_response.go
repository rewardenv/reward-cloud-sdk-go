...
// checks if the ApiPricesGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiPricesGetCollection200Response{}

// ApiPricesGetCollection200Response struct for ApiPricesGetCollection200Response
type ApiPricesGetCollection200Response struct {
	Embedded []PriceJsonhal `json:"_embedded"`
...
func NewApiPricesGetCollection200Response(embedded []PriceJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiPricesGetCollection200Response {
	this := ApiPricesGetCollection200Response{}
...
func (o ApiPricesGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiPricesGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiPricesGetCollection200Response struct {
	value *ApiPricesGetCollection200Response
	isSet bool
}

func (v NullableApiPricesGetCollection200Response) Get() *ApiPricesGetCollection200Response {
	return v.value
}

func (v *NullableApiPricesGetCollection200Response) Set(val *ApiPricesGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiPricesGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiPricesGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiPricesGetCollection200Response(val *ApiPricesGetCollection200Response) *NullableApiPricesGetCollection200Response {
	return &NullableApiPricesGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiPricesGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiPricesGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
