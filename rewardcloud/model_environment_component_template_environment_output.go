...
// EnvironmentComponentTemplateEnvironmentOutput Class EnvironmentComponent
...
func NewEnvironmentComponentTemplateEnvironmentOutput() *EnvironmentComponentTemplateEnvironmentOutput {
	this := EnvironmentComponentTemplateEnvironmentOutput{}
	return &this
}
...
func (o *EnvironmentComponentTemplateEnvironmentOutput) SetCpuNil() {
	o.Cpu.Set(nil)
}
...
func (o *EnvironmentComponentTemplateEnvironmentOutput) SetMemoryNil() {
	o.Memory.Set(nil)
}
...
func (o *EnvironmentComponentTemplateEnvironmentOutput) SetStorageNil() {
	o.Storage.Set(nil)
}
...
func (o *EnvironmentComponentTemplateEnvironmentOutput) SetNodeNil() {
	o.Node.Set(nil)
}
...
func (o *EnvironmentComponentTemplateEnvironmentOutput) SetComponentVersionNil() {
...
type NullableEnvironmentComponentTemplateEnvironmentOutput struct {
	value *EnvironmentComponentTemplateEnvironmentOutput
	isSet bool
}

func (v NullableEnvironmentComponentTemplateEnvironmentOutput) Get() *EnvironmentComponentTemplateEnvironmentOutput {
	return v.value
}

func (v *NullableEnvironmentComponentTemplateEnvironmentOutput) Set(val *EnvironmentComponentTemplateEnvironmentOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableEnvironmentComponentTemplateEnvironmentOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableEnvironmentComponentTemplateEnvironmentOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnvironmentComponentTemplateEnvironmentOutput(val *EnvironmentComponentTemplateEnvironmentOutput) *NullableEnvironmentComponentTemplateEnvironmentOutput {
	return &NullableEnvironmentComponentTemplateEnvironmentOutput{value: val, isSet: true}
}

func (v NullableEnvironmentComponentTemplateEnvironmentOutput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnvironmentComponentTemplateEnvironmentOutput) UnmarshalJSON(src []byte) error {
	v.isSet = true
