...
// checks if the ApiProductsGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiProductsGetCollection200Response{}

// ApiProductsGetCollection200Response struct for ApiProductsGetCollection200Response
type ApiProductsGetCollection200Response struct {
	Embedded []ProductJsonhalProductOutput `json:"_embedded"`
...
func NewApiProductsGetCollection200Response(embedded []ProductJsonhalProductOutput, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiProductsGetCollection200Response {
	this := ApiProductsGetCollection200Response{}
...
func (o *ApiProductsGetCollection200Response) GetEmbedded() []ProductJsonhalProductOutput {
	if o == nil {
		var ret []ProductJsonhalProductOutput
		return ret
	}
...
func (o ApiProductsGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiProductsGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiProductsGetCollection200Response struct {
	value *ApiProductsGetCollection200Response
	isSet bool
}

func (v NullableApiProductsGetCollection200Response) Get() *ApiProductsGetCollection200Response {
	return v.value
}

func (v *NullableApiProductsGetCollection200Response) Set(val *ApiProductsGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiProductsGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiProductsGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiProductsGetCollection200Response(val *ApiProductsGetCollection200Response) *NullableApiProductsGetCollection200Response {
	return &NullableApiProductsGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiProductsGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiProductsGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
