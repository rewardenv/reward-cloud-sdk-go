...
// checks if the ApiCredentialTypesGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiCredentialTypesGetCollection200Response{}

// ApiCredentialTypesGetCollection200Response struct for ApiCredentialTypesGetCollection200Response
type ApiCredentialTypesGetCollection200Response struct {
	Embedded []CredentialTypeJsonhal `json:"_embedded"`
...
func NewApiCredentialTypesGetCollection200Response(embedded []CredentialTypeJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiCredentialTypesGetCollection200Response {
	this := ApiCredentialTypesGetCollection200Response{}
...
func (o ApiCredentialTypesGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiCredentialTypesGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiCredentialTypesGetCollection200Response struct {
	value *ApiCredentialTypesGetCollection200Response
	isSet bool
}

func (v NullableApiCredentialTypesGetCollection200Response) Get() *ApiCredentialTypesGetCollection200Response {
	return v.value
}

func (v *NullableApiCredentialTypesGetCollection200Response) Set(val *ApiCredentialTypesGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiCredentialTypesGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiCredentialTypesGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiCredentialTypesGetCollection200Response(val *ApiCredentialTypesGetCollection200Response) *NullableApiCredentialTypesGetCollection200Response {
	return &NullableApiCredentialTypesGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiCredentialTypesGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiCredentialTypesGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
