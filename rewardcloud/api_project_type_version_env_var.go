...
func (r ProjectTypeVersionEnvVarApiApiProjectTypeVersionEnvVarsGetCollectionRequest) EnvVarValidations(envVarValidations string) ProjectTypeVersionEnvVarApiApiProjectTypeVersionEnvVarsGetCollectionRequest {
	r.envVarValidations = &envVarValidations
	return r
}

func (r ProjectTypeVersionEnvVarApiApiProjectTypeVersionEnvVarsGetCollectionRequest) EnvVarValidations2(envVarValidations2 []string) ProjectTypeVersionEnvVarApiApiProjectTypeVersionEnvVarsGetCollectionRequest {
