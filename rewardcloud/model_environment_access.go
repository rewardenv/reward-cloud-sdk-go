...
type EnvironmentAccess struct {
	...
	Mailhog     NullableString `json:"mailhog,omitempty"`
	Webshell    NullableString `json:"webshell,omitempty"`
...
// GetMailhog returns the Mailhog field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *EnvironmentAccess) GetMailhog() string {
	if o == nil || IsNil(o.Mailhog.Get()) {
		var ret string
		return ret
	}
	return *o.Mailhog.Get()
}

// GetMailhogOk returns a tuple with the Mailhog field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *EnvironmentAccess) GetMailhogOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return o.Mailhog.Get(), o.Mailhog.IsSet()
}

// HasMailhog returns a boolean if a field has been set.
func (o *EnvironmentAccess) HasMailhog() bool {
	if o != nil && o.Mailhog.IsSet() {
		return true
	}
...
// SetMailhog gets a reference to the given NullableString and assigns it to the Mailhog field.
func (o *EnvironmentAccess) SetMailhog(v string) {
	o.Mailhog.Set(&v)
}

// SetMailhogNil sets the value for Mailhog to be an explicit nil
func (o *EnvironmentAccess) SetMailhogNil() {
	o.Mailhog.Set(nil)
}

// UnsetMailhog ensures that no value is present for Mailhog, not even an explicit nil
func (o *EnvironmentAccess) UnsetMailhog() {
	o.Mailhog.Unset()
}

// GetWebshell returns the Webshell field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *EnvironmentAccess) GetWebshell() string {
	if o == nil || IsNil(o.Webshell.Get()) {
		var ret string
		return ret
	}
	return *o.Webshell.Get()
}

// GetWebshellOk returns a tuple with the Webshell field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *EnvironmentAccess) GetWebshellOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return o.Webshell.Get(), o.Webshell.IsSet()
}

// HasWebshell returns a boolean if a field has been set.
func (o *EnvironmentAccess) HasWebshell() bool {
	if o != nil && o.Webshell.IsSet() {
		return true
	}
...
// SetWebshell gets a reference to the given NullableString and assigns it to the Webshell field.
func (o *EnvironmentAccess) SetWebshell(v string) {
	o.Webshell.Set(&v)
}

// SetWebshellNil sets the value for Webshell to be an explicit nil
func (o *EnvironmentAccess) SetWebshellNil() {
	o.Webshell.Set(nil)
}

// UnsetWebshell ensures that no value is present for Webshell, not even an explicit nil
func (o *EnvironmentAccess) UnsetWebshell() {
	o.Webshell.Unset()
}
...
func (o EnvironmentAccess) ToMap() (map[string]interface{}, error) {
	...
	if o.Mailhog.IsSet() {
		toSerialize["mailhog"] = o.Mailhog.Get()
	}
	if o.Webshell.IsSet() {
		toSerialize["webshell"] = o.Webshell.Get()
	}
