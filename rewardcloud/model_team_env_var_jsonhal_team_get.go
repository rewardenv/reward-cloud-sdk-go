...
// checks if the TeamEnvVarJsonhalTeamGet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamEnvVarJsonhalTeamGet{}

// TeamEnvVarJsonhalTeamGet 
type TeamEnvVarJsonhalTeamGet struct {
...
func (o *TeamEnvVarJsonhalTeamGet) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *TeamEnvVarJsonhalTeamGet) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *TeamEnvVarJsonhalTeamGet) SetIsEncryptedNil() {
...
func (o *TeamEnvVarJsonhalTeamGet) SetEnvVarTypeNil() {
...
func (o TeamEnvVarJsonhalTeamGet) MarshalJSON() ([]byte, error) {
...
func (o TeamEnvVarJsonhalTeamGet) ToMap() (map[string]interface{}, error) {
...
type NullableTeamEnvVarJsonhalTeamGet struct {
	value *TeamEnvVarJsonhalTeamGet
	isSet bool
}

func (v NullableTeamEnvVarJsonhalTeamGet) Get() *TeamEnvVarJsonhalTeamGet {
	return v.value
}

func (v *NullableTeamEnvVarJsonhalTeamGet) Set(val *TeamEnvVarJsonhalTeamGet) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamEnvVarJsonhalTeamGet) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamEnvVarJsonhalTeamGet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamEnvVarJsonhalTeamGet(val *TeamEnvVarJsonhalTeamGet) *NullableTeamEnvVarJsonhalTeamGet {
	return &NullableTeamEnvVarJsonhalTeamGet{value: val, isSet: true}
}

func (v NullableTeamEnvVarJsonhalTeamGet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamEnvVarJsonhalTeamGet) UnmarshalJSON(src []byte) error {
	v.isSet = true
