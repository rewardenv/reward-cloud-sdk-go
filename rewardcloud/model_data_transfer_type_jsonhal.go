...
// checks if the DataTransferTypeJsonhal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataTransferTypeJsonhal{}

// DataTransferTypeJsonhal Class DataTransferType
type DataTransferTypeJsonhal struct {
...
func (o *DataTransferTypeJsonhal) SetUuidNil() {
	o.Uuid.Set(nil)
}
...
func (o *DataTransferTypeJsonhal) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *DataTransferTypeJsonhal) SetCodeNameNil() {
	o.CodeName.Set(nil)
}
...
func (o *DataTransferTypeJsonhal) SetCreatedByNil() {
	o.CreatedBy.Set(nil)
}
...
func (o *DataTransferTypeJsonhal) SetUpdatedByNil() {
	o.UpdatedBy.Set(nil)
}
...
func (o DataTransferTypeJsonhal) MarshalJSON() ([]byte, error) {
...
func (o DataTransferTypeJsonhal) ToMap() (map[string]interface{}, error) {
...
type NullableDataTransferTypeJsonhal struct {
	value *DataTransferTypeJsonhal
	isSet bool
}

func (v NullableDataTransferTypeJsonhal) Get() *DataTransferTypeJsonhal {
	return v.value
}

func (v *NullableDataTransferTypeJsonhal) Set(val *DataTransferTypeJsonhal) {
	v.value = val
	v.isSet = true
}

func (v NullableDataTransferTypeJsonhal) IsSet() bool {
	return v.isSet
}

func (v *NullableDataTransferTypeJsonhal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataTransferTypeJsonhal(val *DataTransferTypeJsonhal) *NullableDataTransferTypeJsonhal {
	return &NullableDataTransferTypeJsonhal{value: val, isSet: true}
}

func (v NullableDataTransferTypeJsonhal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataTransferTypeJsonhal) UnmarshalJSON(src []byte) error {
	v.isSet = true
