...
// checks if the ApiProjectTypesGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiProjectTypesGetCollection200Response{}
...
func (o ApiProjectTypesGetCollection200Response) ToMap() (map[string]interface{}, error) {
