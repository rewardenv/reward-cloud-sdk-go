...
// checks if the ProjectEnvVarJsonhalTemplateProjectInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectEnvVarJsonhalTemplateProjectInput{}

// ProjectEnvVarJsonhalTemplateProjectInput 
type ProjectEnvVarJsonhalTemplateProjectInput struct {
...
func NewProjectEnvVarJsonhalTemplateProjectInput() *ProjectEnvVarJsonhalTemplateProjectInput {
	this := ProjectEnvVarJsonhalTemplateProjectInput{}
	return &this
}
...
func (o *ProjectEnvVarJsonhalTemplateProjectInput) SetLinks(v AbstractEnvironmentJsonhalLinks) {
	o.Links = &v
}
...
func (o *ProjectEnvVarJsonhalTemplateProjectInput) SetKeyNil() {
	o.Key.Set(nil)
}
...
func (o *ProjectEnvVarJsonhalTemplateProjectInput) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *ProjectEnvVarJsonhalTemplateProjectInput) SetIsEncryptedNil() {
...
func (o *ProjectEnvVarJsonhalTemplateProjectInput) SetEnvVarTypeNil() {
...
func (o ProjectEnvVarJsonhalTemplateProjectInput) MarshalJSON() ([]byte, error) {
...
func (o ProjectEnvVarJsonhalTemplateProjectInput) ToMap() (map[string]interface{}, error) {
...
type NullableProjectEnvVarJsonhalTemplateProjectInput struct {
	value *ProjectEnvVarJsonhalTemplateProjectInput
	isSet bool
}

func (v NullableProjectEnvVarJsonhalTemplateProjectInput) Get() *ProjectEnvVarJsonhalTemplateProjectInput {
	return v.value
}

func (v *NullableProjectEnvVarJsonhalTemplateProjectInput) Set(val *ProjectEnvVarJsonhalTemplateProjectInput) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectEnvVarJsonhalTemplateProjectInput) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectEnvVarJsonhalTemplateProjectInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectEnvVarJsonhalTemplateProjectInput(val *ProjectEnvVarJsonhalTemplateProjectInput) *NullableProjectEnvVarJsonhalTemplateProjectInput {
	return &NullableProjectEnvVarJsonhalTemplateProjectInput{value: val, isSet: true}
}

func (v NullableProjectEnvVarJsonhalTemplateProjectInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectEnvVarJsonhalTemplateProjectInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
