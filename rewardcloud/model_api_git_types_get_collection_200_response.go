...
// checks if the ApiGitTypesGetCollection200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiGitTypesGetCollection200Response{}

// ApiGitTypesGetCollection200Response struct for ApiGitTypesGetCollection200Response
type ApiGitTypesGetCollection200Response struct {
	Embedded []GitTypeJsonhal `json:"_embedded"`
...
func NewApiGitTypesGetCollection200Response(embedded []GitTypeJsonhal, links ApiComponentResourceLimitsGetCollection200ResponseLinks) *ApiGitTypesGetCollection200Response {
	this := ApiGitTypesGetCollection200Response{}
...
func (o ApiGitTypesGetCollection200Response) MarshalJSON() ([]byte, error) {
...
func (o ApiGitTypesGetCollection200Response) ToMap() (map[string]interface{}, error) {
...
type NullableApiGitTypesGetCollection200Response struct {
	value *ApiGitTypesGetCollection200Response
	isSet bool
}

func (v NullableApiGitTypesGetCollection200Response) Get() *ApiGitTypesGetCollection200Response {
	return v.value
}

func (v *NullableApiGitTypesGetCollection200Response) Set(val *ApiGitTypesGetCollection200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableApiGitTypesGetCollection200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableApiGitTypesGetCollection200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiGitTypesGetCollection200Response(val *ApiGitTypesGetCollection200Response) *NullableApiGitTypesGetCollection200Response {
	return &NullableApiGitTypesGetCollection200Response{value: val, isSet: true}
}

func (v NullableApiGitTypesGetCollection200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiGitTypesGetCollection200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
