...
// checks if the GitProjectInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GitProjectInput{}

// GitProjectInput Class Git
type GitProjectInput struct {
	...
	GitType            NullableGitProjectInputGitType        `json:"gitType,omitempty"`
	CredentialType     NullableGitProjectInputCredentialType `json:"credentialType,omitempty"`
}

// NewGitProjectInput instantiates a new GitProjectInput object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGitProjectInput() *GitProjectInput {
	this := GitProjectInput{}
	return &this
}

// NewGitProjectInputWithDefaults instantiates a new GitProjectInput object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGitProjectInputWithDefaults() *GitProjectInput {
	this := GitProjectInput{}
	return &this
}

// GetRepo returns the Repo field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *GitProjectInput) GetRepo() string {
...
func (o *GitProjectInput) GetRepoOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GitProjectInput) HasRepo() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GitProjectInput) GetUsernameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GitProjectInput) HasUsername() bool {
...
func (o *GitProjectInput) SetUsername(v string) {
	o.Username.Set(&v)
}

// SetUsernameNil sets the value for Username to be an explicit nil
func (o *GitProjectInput) SetUsernameNil() {
	o.Username.Set(nil)
}

// UnsetUsername ensures that no value is present for Username, not even an explicit nil
func (o *GitProjectInput) UnsetUsername() {
	o.Username.Unset()
}

// GetPassword returns the Password field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *GitProjectInput) GetPassword() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GitProjectInput) GetPasswordOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GitProjectInput) HasPassword() bool {
...
func (o *GitProjectInput) SetPassword(v string) {
	o.Password.Set(&v)
}

// SetPasswordNil sets the value for Password to be an explicit nil
func (o *GitProjectInput) SetPasswordNil() {
	o.Password.Set(nil)
}

// UnsetPassword ensures that no value is present for Password, not even an explicit nil
func (o *GitProjectInput) UnsetPassword() {
	o.Password.Unset()
}
...
func (o *GitProjectInput) GetSshPrivateKey() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GitProjectInput) GetSshPrivateKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GitProjectInput) HasSshPrivateKey() bool {
...
func (o *GitProjectInput) GetSshPrivateKeyInput() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GitProjectInput) GetSshPrivateKeyInputOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GitProjectInput) HasSshPrivateKeyInput() bool {
...
func (o *GitProjectInput) UnsetSshPrivateKeyInput() {
...
func (o *GitProjectInput) GetGitType() GitProjectInputGitType {
	if o == nil || IsNil(o.GitType.Get()) {
		var ret GitProjectInputGitType
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GitProjectInput) GetGitTypeOk() (*GitProjectInputGitType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GitProjectInput) HasGitType() bool {
...
// SetGitType gets a reference to the given NullableGitProjectInputGitType and assigns it to the GitType field.
func (o *GitProjectInput) SetGitType(v GitProjectInputGitType) {
	o.GitType.Set(&v)
}

// SetGitTypeNil sets the value for GitType to be an explicit nil
func (o *GitProjectInput) SetGitTypeNil() {
	o.GitType.Set(nil)
}

// UnsetGitType ensures that no value is present for GitType, not even an explicit nil
func (o *GitProjectInput) UnsetGitType() {
	o.GitType.Unset()
}
...
func (o *GitProjectInput) GetCredentialType() GitProjectInputCredentialType {
	if o == nil || IsNil(o.CredentialType.Get()) {
		var ret GitProjectInputCredentialType
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *GitProjectInput) GetCredentialTypeOk() (*GitProjectInputCredentialType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GitProjectInput) HasCredentialType() bool {
...
// SetCredentialType gets a reference to the given NullableGitProjectInputCredentialType and assigns it to the CredentialType field.
func (o *GitProjectInput) SetCredentialType(v GitProjectInputCredentialType) {
	o.CredentialType.Set(&v)
}

// SetCredentialTypeNil sets the value for CredentialType to be an explicit nil
func (o *GitProjectInput) SetCredentialTypeNil() {
	o.CredentialType.Set(nil)
}

// UnsetCredentialType ensures that no value is present for CredentialType, not even an explicit nil
func (o *GitProjectInput) UnsetCredentialType() {
	o.CredentialType.Unset()
}

func (o GitProjectInput) MarshalJSON() ([]byte, error) {
...
func (o GitProjectInput) ToMap() (map[string]interface{}, error) {
...
type NullableGitProjectInput struct {
	value *GitProjectInput
	isSet bool
}

func (v NullableGitProjectInput) Get() *GitProjectInput {
	return v.value
}

func (v *NullableGitProjectInput) Set(val *GitProjectInput) {
	v.value = val
	v.isSet = true
}

func (v NullableGitProjectInput) IsSet() bool {
	return v.isSet
}

func (v *NullableGitProjectInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGitProjectInput(val *GitProjectInput) *NullableGitProjectInput {
	return &NullableGitProjectInput{value: val, isSet: true}
}

func (v NullableGitProjectInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGitProjectInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
